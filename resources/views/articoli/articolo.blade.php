    ...
    <section class="container-fluid">
         <div class="row">
                ...
                <div class="col-12 col-md-6 articletitle-custom">
                    <h1 class="titlearticle">{!!$articolo['titolo']!!}</h1>
                    <h3 class="sottotitlearticle">{{$articolo['sottotitolo']}}</h3>
                </div>
                <div class="col-12 col-md-6 articletext-custom">{{$articolo['testo']}}</div>
            <div class="linea"></div>
         </div>       
    <!-- footer -->
